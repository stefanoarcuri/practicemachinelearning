...
I tried with frustration various techniques, but due to limitation of my machine (4gb RAM) I had to choose for lightest criterias, so decision trees in two ways. 
...
highly.cor <- findCorrelation(cor(training[, -c(last)]), cutoff=0.97)
